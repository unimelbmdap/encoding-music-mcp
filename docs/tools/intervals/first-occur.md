...
The `get_first_occur_melodic_ngrams` tool computes melodic n-grams with CRIM Intervals, then keeps only the earliest occurrence of each distinct pattern across all parts. This is useful when you want a compact catalogue of melodic ideas and their first playback locations.
